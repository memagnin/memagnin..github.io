...
We could scalethe y-axis to better understand the distribution. However, the problem might simply be that articles have variables length. So links far away will have a low count as they both need to be in a long article and need to be at the end of that article. 
...
![Example of the bottom page of the United State article]({{ '/assets/img/US_example_end_page_links.png' | relative_url }})
