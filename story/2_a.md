...
Pearson correlation is 0.7725 and Spearman correlation is 0.8588 on a log-log scale so it means there a power correlation between the number of clicks and the number of incoming links.
</div>
